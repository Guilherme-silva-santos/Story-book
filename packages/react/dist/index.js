...
var AvatarConatiner = styled(Avatar.Root, {
  borderRadius: "$full",
...
var AvatarImage = styled(Avatar.Image, {
  ...
  // como o avatar container é o elemento pai para que não precice colocar o borderradius novamente
...
function Avatar2(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AvatarConatiner, { children: [
...
var Input = styled("input", {
  ...
  "&:focus": {
    outline: 0
    // para quando o elemento pai estiver com focus não pegar o focu s nele também
  },
  "&:disabled": {
    cursor: "not-allowed"
  },
